...
function  readytableName (currElement) {
    ...
    onclickIden.bt1.onclick = () => { getIdenDataTab(currElement, 1); }
    onclickIden.bt2.onclick = () => { getIdenDataTab(currElement, 2); }
    onclickIden.bt3.onclick = () => { getIdenDataTab(currElement, 3); }
    onclickIden.bt4.onclick = () => { getIdenDataTab(currElement, 4); }
    onclickIden.bt5.onclick = () => { getIdenDataTab(currElement, 5); }
    onclickIden.bt6.onclick = () => { getIdenDataTab(currElement, 6); }
    onclickIden.bt7.onclick = () => { getIdenDataTab(currElement, 7); }
    onclickIden.bt8.onclick = () => { getIdenDataTab(currElement, 8); }
    onclickIden.bt9.onclick = () => { getIdenDataTab(currElement, 9); }
    onclickIden.bt10.onclick = () => { getIdenDataTab(currElement, 10); }
    onclickIden.bt11.onclick = () => { getIdenDataTab(currElement, 11); }
    onclickIden.bt12.onclick = () => { getIdenDataTab(currElement, 12); }
    onclickIden.bt13.onclick = () => { getIdenDataTab(currElement, 13); }
    onclickIden.bt14.onclick = () => { getIdenDataTab(currElement, 14); }
    onclickIden.bt15.onclick = () => { getIdenDataTab(currElement, 15); }
    onclickIden.bt16.onclick = () => { getIdenDataTab(currElement, 16); }
    onclickIden.bt17.onclick = () => { getIdenDataTab(currElement, 17); }
    onclickIden.bt18.onclick = () => { getIdenDataTab(currElement, 18); }
}
function getIdenDataTab (id, iden) {
